...
#with lib.hm.gvariant;
{
  ...
  home.file = { 
    ".config/autostart/conky.desktop".text = ''
      ...
      Encoding=UTF-8
      TryExec=conky
      Exec=conky -p 10 -d -b -c "/home/gmdegoug/.config/conky/conky.conf"
      GenericName[en_US]=
      GenericName=
      Hidden=false
      MimeType=
    ...
    ".config/conky/conky.conf".text = ''
      ...
      File systems:''${if_mounted /boot}
        efi ''${fs_used /boot}/''${fs_size /boot} ''${fs_bar 6 /boot}$endif''${if_mounted /nix}
        nix ''${fs_used /nix}/''${fs_size /nix} ''${fs_bar 6 /nix}$endif''${if_mounted /home}
        home ''${fs_used /home}/''${fs_size /home} ''${fs_bar 6 /home}$endif''${if_mounted /srv/public}
        public ''${fs_used /srv/public}/''${fs_size /srv/public} ''${fs_bar 6 /srv/public}$endif''${if_mounted /mnt/backup/internal}
        internal ''${fs_used /mnt/backup/internal}/''${fs_size /mnt/backup/internal} ''${fs_bar 6 /mnt/backup/internal}$endif''${if_mounted /mnt/backup/128Gint}
        128Gint ''${fs_used /mnt/backup/128Gint}/''${fs_size /mnt/backup/128Gint} ''${fs_bar 6 /mnt/backup/128Gint}$endif''${if_mounted /mnt/backup/128Gext}
      ...
      Disk I/O:
        ...
        nvme2n1: ''${diskio nvme2n1} ''${goto 140}''${diskiograph nvme2n1 8,0 104E8B ff0000 -t}
            ...
            sr1: ''${diskio sr1} ''${goto 140}''${diskiograph sr1 8,0 104E8B ff0000 -t}
      ]]
    '';
  };
}
